...
module.exports = {
    name: 'invert',
    category: 'media',
    description: 'Applies a negative/invert color effect to an image.',
    emoji: '🎨',
    async execute(sock, msg, args) {
        ...
        try {
            ...
            const outputPath = path.join(__dirname, `../../../temp_invert_${msg.key.id}.jpg`);

            await sharp(buffer).negate().jpeg().toFile(outputPath);
