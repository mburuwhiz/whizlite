module.exports = {
    name: 'promote',
    category: 'admin',
    description: 'Promotes a user to an admin.',
    emoji: '⬆️',
    async execute(sock, msg, args) {
        ...
        if (targetJids.length === 0) {
            return await sock.sendMessage(remoteJid, { text: 'Please mention a user or reply to their message to promote.' }, { quoted: msg });
        }
